...
public class CubeLevel {
    ...
    @AddFieldToSets(containers = ChunkToCubeSet.ChunkLevel_to_CubeLevel_redirects.class, field = "RADIUS_AROUND_FULL_CHUNK:I")
    ...
    @AddMethodToSets(containers = ChunkToCubeSet.ChunkLevel_to_CubeLevel_redirects.class, method = "isLoaded(I)Z")
